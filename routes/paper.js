...
paper.get('/getAllSubjectType',function(req,resp){
	var sql = "select * from tbl_exam_subjecttype";
	findAllInfo(sql,resp);
})
paper.get('/getAllDepartmentes',function(req,resp){
	var sql = "select * from tbl_exam_department";
	findAllInfo(sql,resp);
})
paper.get('/getAlllevels',function(req,resp){
	var sql = "select * from tbl_exam_subjectlevel";
	findAllInfo(sql,resp);
})
paper.get('/getAllTopics',function(req,resp){
...
function findAllInfo(sql,resp){
	paperDB.findAll(sql).then(function(data){
